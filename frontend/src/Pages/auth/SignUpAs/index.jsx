      ...
      <div className=" space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-500 dark:text-gray-400">
            Choose the type of account youd like to create.
          </p>
        </div>
        <div className="grid gap-4">
          <div className="flex justify-between space-x-8">
            <div className="flex flex-col items-center justify-center gap-4 p-8 border-solid border-black rounded-lg border-2 transition-transform duration-300 hover:scale-105">
              ...
              <div className="inline-flex w-full items-center justify-center rounded-md px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors bg-black focus:ring-gray-950 disabled:opacity-50">
              <Link to="/registerc">
                Sign Up
              </Link>
              </div>
