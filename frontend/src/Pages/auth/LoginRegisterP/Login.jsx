...
import { loginProvider } from '../../../redux/actions/AuthActions.js/index';
...
function Login() {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    dispatch(loginProvider({ email, password })).then((result) => {
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      ...
      >
        ...
        <div className="flex flex-col justify-center p-8 md:p-20">
          ...
          <button
            type="submit"
            className="w-full bg-black text-white p-2 rounded-xl mb-4 hover:bg-white hover:text-black hover:border hover:border-gray-300"
            disabled={loading}
          >
            Sign in
          </button>
