      ...
      <div className=" min-w-[317px] md:flex items-center justify-center  lg:gap-16 m-16  md:py-20 md:my-5">
        <div className="flex flex-col items-start justify-center  max-w-[500px]">
          ...
          <p className="font-imbue text-[19px] md:text-[21px] lg:text-2xl  md:ml-6 text-black mt-9 md:w-[500px]">
            ...
            events by placing a strong emphasis on personalized customer
            service. Our approach is simple: <br /> We hold ourselves to exceptionally
            high standards because you deserve simply the finest.
          </p>
        </div>
