...
function ProviderProfile() {
  ...
  return (
    <div>
      <ProfileNavbar />
      <div className='flex flex-col mx-28 mt-10 border rounded-t-2xl border-[#f3d9cf] shadow-lg py-5 px-9'>
        ...
        {!isFormVisible && (
          <div className='m-20 flex items-center justify-center text-[90px] text-[#e8672f] cursor-pointer'>
            <IoAddCircleOutline
