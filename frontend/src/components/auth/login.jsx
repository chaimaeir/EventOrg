 ...
 function Login() {
    return (
        <div className="flex items-center justify-center  min-h-screen bg-gray-100">
            <div className="relative  flex flex-col m-4 mb-2  bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
                {/* Left side */}
                <div className="flex flex-col justify-center p-8 md:p-14">
                <span className="mb-3 text-4xl font-bold" style={{ fontFamily: 'Poppins' }}>Welcome back!</span>
                    ...
                    <div className="text-center text-gray-400">
                        ...
                        <Link to="/register" className="font-bold text-black">Sign Up</Link></span>
                    </div>
