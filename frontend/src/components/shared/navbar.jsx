...
const Navbar = () => {
  return (
    <nav className="bg-white-800 justify-center py-6 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 h-[40px] flex justify-between items-center font-imbue text-black">
        ...
        <div className="flex justify-between gap-11 items-center">
          ...
          {/* Logo */}
          <Link to="/" className=" ">
            <img className="object-cover h-[70px]" src={Logo} alt="" />
          </Link>
        ...
        <div className="flex  justify-end px-10 ">
          <Link
            to="/login"
            className=" mr-4 text-2xl py-1 px-4 rounded-2xl bg-[#f0f0f0]"
          >
            Sign In
          </Link>
          <Link
            to="/register"
            className=" text-2xl mr-[-50px] rounded-2xl py-1 px-3 text-[#f0f0f0] bg-black"
          >
            Register
          </Link>
        </div>
